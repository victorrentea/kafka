...
import victor.training.kafka.race.Race.Message;
...
import static victor.training.kafka.race.Race.RACE_TOPIC;
...
public class RaceTest extends IntegrationTest {
  ...
  void ok() {
    ...
    final int N_MESSAGES = 1000; // a lower number land on the same partition in recent Kafka producer
