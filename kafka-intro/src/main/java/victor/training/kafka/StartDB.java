...
public class StartDB {
	public static void main(String[] args) throws SQLException {
		...
		System.out.println("Connecting to 'jdbc:h2:tcp://localhost:9099/~/test' will auto-create a database file 'test.mv.db' in user home (~)...");

		deletePreviousDB();

		// Allow auto-creating new databases on disk at first connection
		org.h2.tools.Server.createTcpServer("-ifNotExists", "-tcpPort","9099").start();
	}
