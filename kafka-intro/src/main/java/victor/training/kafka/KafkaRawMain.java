...
public class KafkaRawMain {
  ...
  private static KafkaConsumer<String, String> createConsumer() {
    ...
    props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest"); // re-consume from start
    props.put("internal.leave.group.on.close", "true");
    return new KafkaConsumer<>(props, Serdes.String().deserializer(), Serdes.String().deserializer());
  }
}
